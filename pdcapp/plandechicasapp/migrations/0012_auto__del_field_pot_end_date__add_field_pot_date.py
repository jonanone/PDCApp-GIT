...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pot.end_date'
        db.delete_column('plandechicasapp_pot', 'end_date')

        # Adding field 'Pot.date'
        db.add_column('plandechicasapp_pot', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Pot.end_date'
        db.add_column('plandechicasapp_pot', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Deleting field 'Pot.date'
        db.delete_column('plandechicasapp_pot', 'date')
