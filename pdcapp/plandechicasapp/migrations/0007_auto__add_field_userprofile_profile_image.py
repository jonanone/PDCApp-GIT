...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('plandechicasapp_userprofile', 'profile_image',
                      self.gf('django.db.models.fields.files.FileField')(default='profiles/Universidad_de_Deusto.jpg', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.profile_image'
        db.delete_column('plandechicasapp_userprofile', 'profile_image')
