...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pot.price'
        db.alter_column('plandechicasapp_pot', 'price', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Choice.votes'
        db.alter_column('plandechicasapp_choice', 'votes', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Product.price'
        db.alter_column('plandechicasapp_product', 'price', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Pot.price'
        db.alter_column('plandechicasapp_pot', 'price', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Choice.votes'
        db.alter_column('plandechicasapp_choice', 'votes', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Product.price'
        db.alter_column('plandechicasapp_product', 'price', self.gf('django.db.models.fields.IntegerField')(default=0))
