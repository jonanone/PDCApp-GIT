...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.clicks'
        db.alter_column('plandechicasapp_product', 'clicks', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Product.clicks'
        db.alter_column('plandechicasapp_product', 'clicks', self.gf('django.db.models.fields.IntegerField')(default=0))
