...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpecialDate.date'
        db.alter_column('plandechicasapp_specialdate', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'SpecialDate.date'
        db.alter_column('plandechicasapp_specialdate', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
