...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('plandechicasapp_specialdate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='special_date_owner', to=orm['plandechicasapp.UserProfile'])),
            ('date_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='special_date_type', to=orm['plandechicasapp.DateType'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('plandechicasapp', ['SpecialDate'])

        # Adding model 'DateType'
        db.create_table('plandechicasapp_datetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('plandechicasapp', ['DateType'])


    def backwards(self, orm):
        # Deleting model 'SpecialDate'
        db.delete_table('plandechicasapp_specialdate')

        # Deleting model 'DateType'
        db.delete_table('plandechicasapp_datetype')
