...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field fichajes on 'UserProfile'
        db.create_table('plandechicasapp_userprofile_fichajes', (
        ...
        db.create_unique('plandechicasapp_userprofile_fichajes', ['userprofile_id', 'product_id'])


    def backwards(self, orm):
        # Removing M2M table for field fichajes on 'UserProfile'
        db.delete_table('plandechicasapp_userprofile_fichajes')
    ...
    models = {
        ...
        'plandechicasapp.pot': {
            ...
            'product_list': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'pot_product_list'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['plandechicasapp.Product']"}),
        ...
        'plandechicasapp.product': {
            ...
            'clicks': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'plandechicasapp.userprofile': {
            ...
            'fichajes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user_fichajes'", 'symmetrical': 'False', 'to': "orm['plandechicasapp.Product']"}),
